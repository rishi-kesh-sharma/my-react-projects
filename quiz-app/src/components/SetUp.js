            ...
            <h1 > QUIZ SETUP</h1>
             <form onSubmit={submitHandle}>
                 <div className="form-element">
                    ...
                    <input onChange={changeHandle}  className="amount" type="number"   name="no-of-questions" min="5"  max="20" required/> 
                </div>
                         
                 <div className="form-element">
                    <label  htmlFor="category">Category</label> 
                    <select onChange={changeHandle} className="category" name="category" required>
                 ...
                 <div className="form-element">
                    ...
                    <select  onChange={changeHandle} className="difficulty-level" name="category" required>
                        <option>hard</option>
